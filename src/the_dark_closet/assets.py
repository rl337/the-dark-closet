...
class PinocchioAssetGenerator:
    ...
    def generate_all_assets(self, output_dir: Path) -> Dict[str, str]:
        ...
        # Body parts
        asset_paths['head'] = self._save_asset(self.generate_head(), body_dir / "head.png")
        asset_paths['torso'] = self._save_asset(self.generate_torso(), body_dir / "torso.png")
        asset_paths['left_arm'] = self._save_asset(self.generate_left_arm(), body_dir / "left_arm.png")
        asset_paths['right_arm'] = self._save_asset(self.generate_right_arm(), body_dir / "right_arm.png")
        asset_paths['left_leg'] = self._save_asset(self.generate_left_leg(), body_dir / "left_leg.png")
        asset_paths['right_leg'] = self._save_asset(self.generate_right_leg(), body_dir / "right_leg.png")

        # Facial features
        asset_paths['eyes_open'] = self._save_asset(self.generate_eyes_open(), face_dir / "eyes_open.png")
        asset_paths['eyes_closed'] = self._save_asset(self.generate_eyes_closed(), face_dir / "eyes_closed.png")
        asset_paths['mouth_neutral'] = self._save_asset(self.generate_mouth_neutral(), mouth_dir / "mouth_neutral.png")
        asset_paths['mouth_open'] = self._save_asset(self.generate_mouth_open(), mouth_dir / "mouth_open.png")
