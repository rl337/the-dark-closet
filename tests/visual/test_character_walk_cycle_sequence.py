...
class TestCharacterWalkCycleSequence:
    ...
    def test_walk_cycle_sequence(self):
        ...
        assert character.direction == CharacterDirection.RIGHT  # Last action was walk_right
    ...
    def test_character_state_transitions(self):
        ...
        character.idle()
        assert character.state == CharacterState.IDLE
        assert character.direction == CharacterDirection.RIGHT  # Direction preserved from walk_right
